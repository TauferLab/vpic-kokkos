...
// -----------------------------------------------------------------------------
// HELPER: "Boring" HDF5 File Access Property List (FAPL)
// Ablation Test: Removes Lustre stripe alignment and metadata cache deferrals
// -----------------------------------------------------------------------------
static hid_t create_optimized_fapl(bool single_file) {
    ...
    if (single_file) {
        ...
        // Required to prevent instant Lustre MDS collapse during file open
    ...
    // ABLATION: Removed H5Pset_alignment (Lustre Stripe alignment stripped)
    // ABLATION: Removed H5AC_cache_config_t tuning (Metadata cache defaults restored)
...
void vpic_simulation::write_particles_hdf5(const char* fbase, const char* species_name, bool single_file) {
    KOKKOS_TIC() {
        ...
        // =========================================================================
        // Phase 3: Chunk Allocation & Pipeline
        // =========================================================================
        const int PBUF_SIZE = 2097152; // Maintain 2M particles per chunk (~64MB)
        particle_t* p_buf;
        MALLOC_ALIGNED(p_buf, PBUF_SIZE, 128);
